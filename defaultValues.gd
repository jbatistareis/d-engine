...
var facts : Dictionary = {
	Enums.Fact.ANY: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn _suspects',
	
	Enums.Fact.HP_HIGHEST: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHighestHp(_suspects)',
	Enums.Fact.HP_LOWEST: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByLowestHp(_suspects)',
	
	Enums.Fact.HP_GREATER_95: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpGt(_suspects, 0.95)',
	Enums.Fact.HP_GREATER_75: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpGt(_suspects, 0.75)',
	Enums.Fact.HP_GREATER_50: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpGt(_suspects, 0.50)',
	Enums.Fact.HP_GREATER_35: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpGt(_suspects, 0.35)',
	Enums.Fact.HP_GREATER_15: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpGt(_suspects, 0.15)',
	Enums.Fact.HP_GREATER_5: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpGt(_suspects, 0.05)',
	Enums.Fact.HP_LOWER_95: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpLt(_suspects, 0.95)',
	Enums.Fact.HP_LOWER_75: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpLt(_suspects, 0.75)',
	Enums.Fact.HP_LOWER_50: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpLt(_suspects, 0.50)',
	Enums.Fact.HP_LOWER_35: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpLt(_suspects, 0.35)',
	Enums.Fact.HP_LOWER_15: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpLt(_suspects, 0.15)',
	Enums.Fact.HP_LOWER_5: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByHpLt(_suspects, 0.05)',
	
	Enums.Fact.MOD_3_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.ATK, 3)',
	Enums.Fact.MOD_GT_2_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.ATK, 2)',
	Enums.Fact.MOD_GT_1_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.ATK, 1)',
	Enums.Fact.MOD_LT_0_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.ATK, 0)',
	Enums.Fact.MOD_LT_M1_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.ATK, -1)',
	Enums.Fact.MOD_LT_M2_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.ATK, -2)',
	Enums.Fact.MOD_M3_ATK: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.ATK, -3)',
	
	Enums.Fact.MOD_3_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.DEF, 3)',
	Enums.Fact.MOD_GT_2_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.DEF, 2)',
	Enums.Fact.MOD_GT_1_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.DEF, 1)',
	Enums.Fact.MOD_LT_0_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.DEF, 0)',
	Enums.Fact.MOD_LT_M1_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.DEF, -1)',
	Enums.Fact.MOD_LT_M2_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.DEF, -2)',
	Enums.Fact.MOD_M3_DEF: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.DEF, -3)',
	
	Enums.Fact.MOD_3_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.CD, 3)',
	Enums.Fact.MOD_GT_2_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.CD, 2)',
	Enums.Fact.MOD_GT_1_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModGt(_suspects, Enums.MoveModifierType.CD, 1)',
	Enums.Fact.MOD_LT_0_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.CD, 0)',
	Enums.Fact.MOD_LT_M1_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.CD, -1)',
	Enums.Fact.MOD_LT_M2_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.CD, -2)',
	Enums.Fact.MOD_M3_CD: 'func execute(_auditor : Character, _suspects : Array) -> Array[Character]:\n\treturn CharacterQuery.findByMovModLt(_suspects, Enums.MoveModifierType.CD, -3)',
}
